...
export default function ResetPassword() {
  ...
  if (!token) {
    return (
      <AuthLayout title="Reset link unavailable" subtitle="This password reset link cannot be used.">
  ...
  if (done) {
    return (
      <AuthLayout title="Password updated" subtitle="Your Executive Hostel account is ready to use.">
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 32, marginBottom: 8 }}>✓</div>
          <p style={{ fontSize: 14, marginBottom: 16 }}>Your password has been changed. All previous sessions have been signed out for security.</p>
  ...
  return (
    <AuthLayout title="Set a new password" subtitle="Choose a new password with at least 8 characters.">
